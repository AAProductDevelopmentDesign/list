...
class CustomListTp {
  ...
  static get toolbox() {
    return {
      ...
      <g>
        <path d="M232.51,176.54l-6,34.38H199.41l-7.47,49.54c-1.07,7.9,1.28,11.75,11.53,11.75h23.92l-6.2,37.58H175.92c-18.58,0-29.68-14.31-27.12-30.54l10.89-68.33H143.25l6-34.38h15.59l5.34-36.95H209l-5.12,36.95Z"/>
        <path d="M380.93,227.15a83.53,83.53,0,0,1-21.78,56.37c-26.27,28.41-60.65,26.91-60.65,26.91l-6.19-15.59c-7.9,50-13.24,79.44-13.24,79.44H238.92l26.69-159.94H247.46l5.13-37.59h57.65l-1.49,8.76c8.33-5.56,19.86-9,31-9,10.25,0,20.08,3,27.12,10C375.8,195.54,380.93,210.49,380.93,227.15Zm-50.83-17.3c-11.1,0-25.62,9.61-28.4,26.48l-6.62,38.44c9.61,2.35,25.41-4.48,35.67-17.3,7.25-9,12.38-22.85,12.38-33.1,0-5.55-1.49-10-4.91-12.38A14.86,14.86,0,0,0,330.1,209.85Z"/>
      </g>
    </svg>`,
  ...
  render() {
    ...
    label.innerText = 'Teaching Point'
  ...
  get CSS() {
    return {
      ...
      wrapper: 'tp-list',
      wrapperOrdered: 'tp-list--ordered',
      wrapperUnordered: 'tp-list--unordered',
      item: 'tp-list__item',
      settingsWrapper: 'tp-list-settings',
